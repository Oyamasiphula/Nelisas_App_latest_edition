...
var purchasesFile = './data/NelisaPurchases.csv';
var salesFile = './data/NelisaSalesHistory.csv';
...
exports.getProfitPerProducts = function(salesFile,purchasesFile){
 ...
 exports.getLeastProfitableProduct = function(profitMap){
 	...
 	var productName = "";
    var profitPricePerProduct = 10000000000000;
 ...
 exports.getMostProfitableCategory = function(){
    ...
    console.log(profitPricePerCategoryMap + " checking");
